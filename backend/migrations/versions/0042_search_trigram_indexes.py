"""pg_trgm + GIN indexes for the global name search (ADR-0072)

Revision ID: 0042_search_trigram_indexes
Revises: 0041_session_impersonated_by
...
revision: str = "0042_search_trigram_indexes"
down_revision: str | None = "0041_session_impersonated_by"
